...
export const ENCOURAGEMENT_WALL = [
  { message: "Strong is beautiful", icon: "Star" },
  { message: "Progress not perfection", icon: "Star" },
  { message: "You are enough", icon: "Heart" },
  { message: "One day at a time", icon: "PawPrint" },
  { message: "Be your own kind of beautiful", icon: "Star" },
  { message: "Believe in your sparkle", icon: "Sparkles" },
  { message: "You've got this", icon: "Star" },
  { message: "Self love is the best love", icon: "Heart" },
  { message: "Keep going queen", icon: "Star" },
  { message: "Trust your journey", icon: "Star" },
  { message: "Breathe and believe", icon: "PersonStanding" },
  { message: "Dream big, start small", icon: "Star" },
  { message: "Today is your day", icon: "Star" },
  { message: "Radiate positivity", icon: "Sun" },
  { message: "You are magic", icon: "Star" },
  { message: "Stay pawsitive", icon: "Dog" },
  { message: "Glow from within", icon: "Moon" },
  { message: "Create your own sunshine", icon: "Star" },
  { message: "Unstoppable", icon: "Wind" },
  { message: "Born to sparkle", icon: "Gem" },
];
